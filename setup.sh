...
vim -c "execute 'CocInstall -sync coc-actions' | qa"
vim -c "execute 'CocInstall -sync coc-clangd' | qa"
vim -c "execute 'CocInstall -sync coc-cmake' | qa"
vim -c "execute 'CocInstall -sync coc-css' | qa"
vim -c "execute 'CocInstall -sync coc-eslint' | qa"
vim -c "execute 'CocInstall -sync coc-git' | qa"
vim -c "execute 'CocInstall -sync coc-highlight' | qa"
vim -c "execute 'CocInstall -sync coc-html' | qa"
vim -c "execute 'CocInstall -sync coc-json' | qa"
vim -c "execute 'CocInstall -sync coc-markdownlint' | qa"
vim -c "execute 'CocInstall -sync coc-python' | qa"
vim -c "execute 'CocInstall -sync coc-spell-checker' | qa"
vim -c "execute 'CocInstall -sync coc-tslint' | qa"
vim -c "execute 'CocInstall -sync coc-tsserver' | qa"
vim -c "execute 'CocInstall -sync coc-vimlsp' | qa"
vim -c "execute 'CocInstall -sync coc-yaml' | qa"
